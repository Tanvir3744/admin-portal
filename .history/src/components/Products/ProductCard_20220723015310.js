...
const ProductCard = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1'>
            {
                productState.map(product => <div class="card card-compact w-96 bg-base-100 shadow-xl p-6">
